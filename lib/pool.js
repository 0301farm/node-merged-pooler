...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    if (!(options.coin.algorithm in generic_algos)){
    ...
    function OutputPoolInfo(){
        ...
        var infoLines = [startMessage,
                ...
                'Current Block Diff:\t' + _this.jobManager.currentJob.difficulty * generic_algos[options.coin.algorithm].multiplier,
    ...
    function DetectCoinData(finishedCallback){
        ...
        _this.daemon.batchCmd(batchRpcCalls, function(error, results){
            ...
            options.initStats = {
                ...
                difficulty: rpcResults.getinfo.difficulty * generic_algos[options.coin.algorithm].multiplier,
